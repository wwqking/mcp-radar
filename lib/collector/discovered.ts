...
export const DISCOVERED_SEEDS: CuratedSeed[] = [
  ...
  // 自动追加：2026-08-03
  { name: "serpapi-mcp", repoUrl: "https://github.com/serpapi/serpapi-mcp", npmPackage: null }, // ★162 · 170/mo 有人搜
  { name: "alpaca-mcp-server", repoUrl: "https://github.com/alpacahq/alpaca-mcp-server", npmPackage: null }, // ★899 · 140/mo 有人搜
  { name: "health-auto-export-mcp-server", repoUrl: "https://github.com/HealthyApps/health-auto-export-mcp-server", npmPackage: null }, // ★59 · 140/mo 有人搜
  { name: "okta-mcp-server", repoUrl: "https://github.com/okta/okta-mcp-server", npmPackage: null }, // ★52 · 140/mo 有人搜
  { name: "prometheus-mcp-server", repoUrl: "https://github.com/pab1it0/prometheus-mcp-server", npmPackage: null }, // ★510 · 140/mo 有人搜
  { name: "sonarqube-mcp-server", repoUrl: "https://github.com/SonarSource/sonarqube-mcp-server", npmPackage: null }, // ★613 · 140/mo 有人搜
  { name: "duckduckgo-mcp-server", repoUrl: "https://github.com/nickclyde/duckduckgo-mcp-server", npmPackage: null }, // ★1394 · 110/mo 有人搜
  { name: "outlook-mcp", repoUrl: "https://github.com/ryaker/outlook-mcp", npmPackage: null }, // ★419 · 110/mo 有人搜
  { name: "ssh-mcp-server", repoUrl: "https://github.com/classfang/ssh-mcp-server", npmPackage: null }, // ★718 · 110/mo 有人搜
  { name: "ghidra-mcp", repoUrl: "https://github.com/bethington/ghidra-mcp", npmPackage: null }, // ★3125 · GitHub 趋势
  { name: "markdownify-mcp", repoUrl: "https://github.com/zcaceres/markdownify-mcp", npmPackage: null }, // ★2901 · GitHub 趋势
  { name: "jadx-ai-mcp", repoUrl: "https://github.com/zinja-coder/jadx-ai-mcp", npmPackage: null }, // ★2592 · GitHub 趋势
  { name: "brightdata-mcp", repoUrl: "https://github.com/brightdata/brightdata-mcp", npmPackage: null }, // ★2556 · GitHub 趋势
  { name: "js-reverse-mcp", repoUrl: "https://github.com/zhizhuodemao/js-reverse-mcp", npmPackage: "js-reverse-mcp" }, // ★2381 · GitHub 趋势
  { name: "korean-law-mcp", repoUrl: "https://github.com/chrisryugj/korean-law-mcp", npmPackage: "korean-law-mcp" }, // ★2363 · GitHub 趋势
  { name: "mcp2cli", repoUrl: "https://github.com/knowsuchagency/mcp2cli", npmPackage: null }, // ★2337 · GitHub 趋势
  { name: "gemini-mcp-tool", repoUrl: "https://github.com/jamubc/gemini-mcp-tool", npmPackage: "gemini-mcp-tool" }, // ★2269 · GitHub 趋势
  { name: "ios-simulator-mcp", repoUrl: "https://github.com/joshuayoes/ios-simulator-mcp", npmPackage: "ios-simulator-mcp" }, // ★2118 · GitHub 趋势
  { name: "mcpb", repoUrl: "https://github.com/modelcontextprotocol/mcpb", npmPackage: null }, // ★2063 · GitHub 趋势
];
